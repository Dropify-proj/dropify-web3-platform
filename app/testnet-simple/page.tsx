      ...
      <div className="container mx-auto px-4 py-16">
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 hover:bg-white/15 transition-all">
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed py-4 rounded-xl font-semibold text-lg transition-all duration-200 flex items-center justify-center hover:scale-105"
                >
                  {isCreating ? (
                    <>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 hover:bg-white/15 transition-all">
              <div className="text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <button className="bg-green-600 hover:bg-green-700 py-3 rounded-xl font-semibold transition-all hover:scale-105">
                    Get Testnet Tokens
                  </button>
                  <button className="bg-blue-600 hover:bg-blue-700 py-3 rounded-xl font-semibold transition-all hover:scale-105">
        ...
        <div className="text-center mt-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 px-8 py-3 rounded-xl font-semibold transition-all duration-200 hover:scale-105">
              Share Feedback
            </button>
            <button className="border border-white/30 hover:bg-white/10 px-8 py-3 rounded-xl font-semibold transition-all duration-200 hover:scale-105">
              View Documentation
            </button>
          </div>
        </div>
